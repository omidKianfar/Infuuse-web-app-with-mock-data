	...
	return (
		<svg width={width} height={height} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
			...
			<path
				...
				fill={fill?.fill2 ? fill?.fill2 : fill}
			/>
			<path
				d="M22.0508 15.2575V23.9924H25.8428C25.8428 23.9924 26.9219 23.8813 26.9995 22.6513V11.459L22.0508 15.2575Z"
				fill={fill?.fill3 ? fill?.fill3 : fill}
			/>
			<path d="M9.94811 24.0001V15.0732L9.94043 15.0669L9.94811 24.0001Z" fill={fill.fill4 ? fill.fill4 : fill} />
			<path
				d="M9.94014 8.52404L8.37646 7.39382C5.60179 5.91001 5 9.17692 5 9.17692V11.4651L9.94014 15.0667V8.52404Z"
				fill={fill?.fill4 ? fill?.fill4 : fill}
			/>
			<path
			...
			<path
				...
				fill={fill?.fill5 ? fill?.fill5 : fill}
			/>
		</svg>
	);
};
