	...
	return (
		...
		>
			<g id="edit-2" transform="translate(-684 -252)">
				<path
					id="Vector"
					d="M18.75,1.5H.75A.755.755,0,0,1,0,.75.755.755,0,0,1,.75,0h18a.755.755,0,0,1,.75.75A.755.755,0,0,1,18.75,1.5Z"
					transform="translate(686.25 272.5)"
					fill={fill}
				/>
				<path
					id="Vector-2"
					...
					transform="translate(695.865 254.006)"
					fill={fill}
				/>
				<path
					id="Vector-3"
					...
					transform="translate(687.494 258.05)"
					fill={fill}
				/>
				<path
					id="Vector-4"
