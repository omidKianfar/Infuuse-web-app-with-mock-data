...
const MonthlyChart = ({ chartShow,setChartShow }: Props) => {
						...
						<Stack direction={'row'} justifyContent={'end'} alignItems={'center'}>
							<CustomBox mr={1}>
								<Box
									...
									mr={1}
								></Box>
								<Typography>Calls under 180 seconds</Typography>
							</CustomBox>

							<CustomBox mr={1} onClick={() => setChartShow(!chartShow)} sx={{cursor:'pointer'}}>
								<Box
									borderRadius={'4px'}
									bgcolor={'#FFBC01'}
									width={'16px'}
