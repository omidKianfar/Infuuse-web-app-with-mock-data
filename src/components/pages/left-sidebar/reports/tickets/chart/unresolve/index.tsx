...
const TicketUnResolveMonthlyChart = ({ title }: Props) => {
		...
		datasets: [
			{
				...
				backgroundColor: 'rgba(225, 188, 1, 0.8)', // Color of the filled area
				borderColor: 'rgba(225, 188, 1, 0.8)', // Line color
				borderWidth: 2, // Width of the line
				tension: 0.4, // Smooths the line
				pointBackgroundColor: 'rgba(225, 188, 1, 0.8)',
...
export default TicketUnResolveMonthlyChart;
