...
import AddSubscriptionBusiness from './add-subscription/business';
...
const tabs = [
	{ title: 'Subscription For Business', value: '1' },
	{ title: 'Subscription For Agency', value: '2' },
	{ title: 'revenue Log', value: '3' },
];
