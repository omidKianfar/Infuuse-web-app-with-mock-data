...
import phonesStore, { Phones } from '@/store/phones.store';
...
const EditContactModal = ({ handleClose, contact }: Props) => {
	// ------------------------------- tools
	...
	if (NetworkPhonesData && NetworkPhonesData?.length > 0) {
		phonesStore.phones = NetworkPhonesData as unknown as { id: number; value: string }[];
	}
	// network addresses
