...
import {
    AttachmentType,
    useInternalChat_AddInternalMessageMutation,
                ...
                <Stack width={'100%'} direction={'row'} justifyContent={'space-between'} alignItems={'center'} mt={1}>
                    ...
                    <Stack direction={'row'} justifyContent={'end'} alignItems={'center'}>
                        ...
                        <NextButton onClick={sendHandler}
                            disabled={IsUploading || sendInternalChatLoading}
                            isLoading={IsUploading || sendInternalChatLoading}>
                            <SendIcon />
                        </NextButton>
                    </Stack>
                </Stack>
...
export default InternalChatFooter;
