...
import {
    AttachmentType,
    useSupportChat_AddSupportMessageByAdminMutation,
...
import SupportChatComponent from './components/support';

const AdminSupportFooter = () => {
            ...
            >
                ...
                <Stack width={'100%'} direction={'row'} justifyContent={'space-between'} alignItems={'center'} mt={1}>
                    ...
                    <Stack direction={'row'} justifyContent={'end'} alignItems={'center'}>
                        ...
                        <NextButton onClick={sendHandler} disabled={IsUploading || senSupportLoading} isLoading={IsUploading || senSupportLoading}>
                            <SendIcon />
                        </NextButton>
                    </Stack>
                </Stack>
...
export default AdminSupportFooter;
